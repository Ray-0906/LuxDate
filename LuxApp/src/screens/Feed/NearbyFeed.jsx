...
export default function NearbyFeed({ onOpenProfile }) {
    ...
    <Pressable onPress={() => onOpenProfile(item)} style={styles.card}>
      ...
      <View style={styles.cardInfo}>
        ...
        <View style={styles.distRow}>
          <Ionicons name="navigate-outline" size={12} color={theme.colors.accentGreen} />
  ...
  return (
    <FlatList
      ...
      ListEmptyComponent={
        <View style={styles.center}>
          <Text style={styles.emptyText}>No nearby profiles</Text>
        </View>
      }
    />
  );
...
const styles = StyleSheet.create({
  ...
  distText: { fontSize: 11, color: theme.colors.accentGreen, fontWeight: '600' },
